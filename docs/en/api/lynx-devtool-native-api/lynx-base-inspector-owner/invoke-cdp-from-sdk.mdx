...
This can be used simultaneously with the [DevTool desktop application](/guide/devtool#running-the-devtool-desktop-application-on-a-development-device) without any interference.
